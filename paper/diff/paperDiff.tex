...
As mentioned before, the objective of this paper is to propose an MO-MCTS algorithm that is suitable for real-time domains. Although the work discussed here is influenced by Wang's approach, some modifications need to be \DIFdelbegin \DIFdel{done }\DIFdelend \DIFaddbegin \DIFadd{made }\DIFaddend in order to overcome the high computational cost involved in their approach.
