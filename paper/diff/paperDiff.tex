...
Two main goals can be identified in this paper: first, the proposed algorithm must be applicable to real-time domains (those where the next move to make must be decided within a small time budget) and it should obtain better or at least the same performance than the other \DIFdelbegin \DIFdel{state-of-the-art }\DIFdelend algorithms. It is important to highlight that all three algorithms tested employ the same heuristic functions to evaluate the features of a given game state. Thus, the focus of this research is set on how the algorithm explores the search space, instead of providing the best possible solution to each given problem. 
...
\item Elitism: The \DIFdelbegin \DIFdel{solutions in }\DIFdelend \DIFaddbegin \DIFadd{individuals from }\DIFaddend the first front $F_0$ \DIFdelbegin \DIFdel{always survive to the next population}\DIFdelend \DIFaddbegin \DIFadd{are always ranked first, according to the dominance criterion and their crowding distance}\DIFaddend . 
\end{itemize}
...
\hline
\end{tabular}
\caption{\DIFdelbeginFL \DIFdelFL{MO-MCTS results in }\DIFdelendFL MO-PTSP \DIFaddbeginFL \DIFaddFL{averages (plus standard error) }\DIFaddendFL with different weight vectors. \DIFdelbeginFL \DIFdelFL{Significantly better results per map are }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{Results }\DIFaddendFL in bold \DIFaddbeginFL \DIFaddFL{obtained an independent t-test p-value $<0.01$}\DIFaddendFL .}
\label{tab:weights}
\end{center}
\end{table}
...
%DIF >  & $W_3$ & $1681$ & $131$ $(1.0)$ & $837$\\
%DIF >  & $W_4$ & $1649$ $(0.63)$ & $132$ & $833$\\
%DIF > \hline
%DIF >  \multirow{3}{*}{\textbf{Map 2}} & $W_1$ & $1409$ & $235$& $364$\\
%DIF >  & $W_2$ & $1402$ & $236$ & \textbf{354} \bm{$(<0.01)$}\\
%DIF >  & $W_3$ & $1416$ & \textbf{219} \bm{$(<0.01)$} & $360$\\
%DIF >  & $W_4$ & $1396$ $(0.22)$ & $245$ & $361$\\
%DIF > \hline
%DIF >  \multirow{3}{*}{\textbf{Map 3}} & $W_1$ & $1373$ & $221$& $301$\\
%DIF >  & $W_2$ & $1378$ & $211$ & \textbf{268} \bm{$(<0.01)$}\\
%DIF >  & $W_3$ & $1385$ & \textbf{203} \bm{$(<0.01)$} & $291$\\
%DIF >  & $W_4$ & $1363$ $(0.17)$ & $229$ & $285$\\
%DIF > \hline
%DIF >  \multirow{3}{*}{\textbf{Map 4}} & $W_1$ & $1383$ & $291$& $565$\\
%DIF >  & $W_2$ & $1385$ & $304$ & \textbf{542} \bm{$(<0.01)$}\\
%DIF >  & $W_3$ & $1423 $ & \textbf{273} \bm{$(<0.01)$} & $583$\\
%DIF >  & $W_4$ & $1388$ $(0.55)$ & $309$ & $559$\\
%DIF > \hline
%DIF >  \multirow{3}{*}{\textbf{Map 5}} & $W_1$ & $1405$ & $467$& $559$\\
%DIF >  & $W_2$ & $1431$ & $447$ & \textbf{541} \bm{$(<0.01)$}\\
%DIF >  & $W_3$ & $1467$ & \textbf{411} \bm{$(<0.01)$} & $567$\\
%DIF >  & $W_4$ & $1399$ $(0.60)$ & $469$ & $547$\\
%DIF > \hline
%DIF >  \multirow{3}{*}{\textbf{Map 6}} & $W_1$ & $1575$ & $549$& $303$\\
%DIF >  & $W_2$ & $1626$ & $540$ & \textbf{286} \bm{$(0.01)$}\\
%DIF >  & $W_3$ & $1703$ & \textbf{499} \bm{$(<0.01)$} & $316$\\
%DIF >  & $W_4$ & $1571$ $(0.68)$ & $559$ & $294$\\
%DIF > \hline
...
%DIF >  & $W_2$ & $1804$ & $269$ & \textbf{357} \bm{$(<0.01)$}\\
...
%DIF >  & $W_4$ & $2470$ $(0.06)$ & $956$ & $573$\\
%DIF > \hline
%DIF >  \multirow{3}{*}{\textbf{Map 10}} & $W_1$ & $1430$ & $630$& $205$\\
%DIF >  & $W_2$ & $1493$ & $615$ & $209$ $(0.16)$\\
%DIF >  & $W_3$ & $1542$ & \textbf{554} \bm{$(<0.01)$} & $229$\\
%DIF >  & $W_4$ & \textbf{1378} \bm{$(<0.01)$} & $663$ & $202$\\
%DIF > \hline
%DIF > \end{tabular}
%DIF > \egroup
%DIF > \caption{MO-PTSP averages with different weight vectors. Includes p-values for the objective with the highest weight. Results in bold are statistically significant (p-value $<0.05$).}
