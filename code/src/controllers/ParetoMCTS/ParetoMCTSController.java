...
public class ParetoMCTSController extends Controller {
    ...
    public ParetoMCTSController(Game a_game, long a_timeDue)
    {
        ...
        m_player = new ParetoMCTSPlayer(new SimpleHVTreePolicy(K), m_rnd, new double[]{0.33, 0.33, 0.33});
    ...
    public int getAction(Game a_game, long a_timeDue)
    {
        ...
        if(cycle == 0)
        {
            ...
            m_resetRS = true;
            m_currentMacroAction = RandomSearchTOBEDELETED.MACRO_ACTION_LENGTH-1;
        }else
        {
    ...
    public void prepareGameCopy(Game a_game)
    {
        ...
        if(m_lastMacroAction != -1)
        {
            ...
            int first = RandomSearchTOBEDELETED.MACRO_ACTION_LENGTH - m_currentMacroAction - 1;
            for(int i = first; i < RandomSearchTOBEDELETED.MACRO_ACTION_LENGTH; ++i)
            {
